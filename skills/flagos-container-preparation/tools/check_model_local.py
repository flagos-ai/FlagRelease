...
DEFAULT_SEARCH_PATHS = ["/mnt/data/", "/data", "/data1", "/data2", "/nfs", "/share", "/models", "/home"]
CONTAINER_SEARCH_PATHS = ["/mnt/data/", "/data", "/data1", "/data2", "/models", "/root", "/home", "/workspace", "/mnt", "/opt"]
DEFAULT_MAX_DEPTH = 4
